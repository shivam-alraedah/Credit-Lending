...
| `.github/workflows/ci.yml` | CI runs tests; **docs-pdf** job builds PDF artifacts for long-form design documents |
| `scripts/export_pdfs.sh` | Local PDF (or HTML fallback without LaTeX) for the same docs + this criteria map |
